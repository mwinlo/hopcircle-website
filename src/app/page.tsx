...
function AppShowcase() {
  const screens = [
    ...
    { label: "Hopped In!", sub: "Instant confirmation", src: "/images/screen-hopped-in.png" },
    { label: "Open a Circle", sub: "Host a playdate for a hopper", src: "/images/screen-open-circle.png" },
    { label: "Invitation Sent", sub: "They'll confirm when ready", src: "/images/screen-invitation-sent.png" },
